...
def run_family(start_node: str, sign: str) -> None:
    base_stress = (8, 8, 8)
    base_mismatch = (4, 4, 4)

    print("\n====================")
    print(f"FAMILY: {start_node}")
    print("====================")
    ...
    print("\n-- stress on all carriers equally --")
    for amp in range(MAX_AMP + 1):
        result = stabilized_offset(
            start_node,
            sign,
...
def main() -> None:
    print("\n====================")
    print("LARGE DEFECT THRESHOLD SWEEP")
    print("====================")
    print("Sweep defect amplitudes and test whether stabilized offsets remain exact and relock persists.")
