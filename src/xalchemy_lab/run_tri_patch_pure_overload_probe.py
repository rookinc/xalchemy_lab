...
def make_world() -> World:
    return World(
        turtles={
            "L1": Turtle(name="L1", chirality="L", node="u1R", carry_sign="+"),
            "L2": Turtle(name="L2", chirality="L", node="u1R", carry_sign="+"),
            "R1": Turtle(name="R1", chirality="R", node="u1R", carry_sign="+"),
        }
    )
...
def print_case_result(label: str, stress_triplet: tuple[int, int, int], world_before: World, world_after: World) -> None:
    c = world_after.collisions[-1]
    ledger_before = world_before.hub_ledger["u1R"]
    ledger_after = world_after.hub_ledger["u1R"]
...
def main() -> None:
    ...
    print("\n====================")
    print("SCENARIO: pure_overload_probe")
    print("====================")
    print("All cases are sign-coherent (+,+,+) with zero mismatch at u1R.")
