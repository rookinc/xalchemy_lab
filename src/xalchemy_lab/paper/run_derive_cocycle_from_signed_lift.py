...
def main() -> None:
    ...
    Path("specs/paper/bridge/tree_gauge_representative_v1.json").write_text(json.dumps(out, indent=2) + "\n")
    ...
    print("\nUpdated specs/paper/bridge/tree_gauge_representative_v1.json\n")
