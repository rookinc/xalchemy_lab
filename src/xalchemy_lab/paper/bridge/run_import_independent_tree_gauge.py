...
def main() -> None:
    in_path = Path("specs/paper/bridge/tree_gauge_representative_import_v1.json")
    out_path = Path("specs/paper/bridge/tree_gauge_representative_v1.json")

    if not in_path.exists():
        raise FileNotFoundError(
            "Missing specs/paper/bridge/tree_gauge_representative_import_v1.json"
        )
