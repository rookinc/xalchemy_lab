...
def main() -> None:
    loops = load_json("specs/paper/bridge/signed_lift_bridge_loops_v1.json")
    aliases = load_json("specs/paper/bridge/bridge_edge_aliases_v1.json")["aliases"]
    ...
    out = {
        ...
        "source_loop_spec": "specs/paper/bridge/signed_lift_bridge_loops_v1.json",
        "source_aliases": "specs/paper/bridge/bridge_edge_aliases_v1.json",
        "loops": resolved_loops
    }

    write_json("specs/paper/bridge/signed_lift_bridge_loops_resolved_v1.json", out)
    print("wrote specs/paper/bridge/signed_lift_bridge_loops_resolved_v1.json")
