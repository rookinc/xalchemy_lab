...
def main() -> None:
    loops = load_json("specs/paper/bridge/signed_lift_bridge_loops_resolved_v1.json")["loops"]
    edge_cocycle = load_json("specs/paper/bridge/resolved_edge_cocycle_v1.json")["edge_cocycle"]
