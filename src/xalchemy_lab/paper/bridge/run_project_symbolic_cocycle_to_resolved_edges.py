...
def main() -> None:
    ...
    symbolic = load_json("specs/paper/bridge/tree_gauge_representative_v1.json")
    ...
    out = {
        ...
        "source_tree_gauge": "specs/paper/bridge/tree_gauge_representative_v1.json",
        "source_aliases": "specs/paper/bridge/bridge_edge_aliases_v1.json",
        "edge_cocycle": projected
    }

    write_json("specs/paper/bridge/resolved_edge_cocycle_v1.json", out)
    ...
    print("\nWrote specs/paper/bridge/resolved_edge_cocycle_v1.json\n")
