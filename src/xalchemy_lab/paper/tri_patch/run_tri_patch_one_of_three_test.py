...
def scenario_one_of_three_remote_reentry():
    print("\n====================")
    print("SCENARIO: one_of_three_remote_reentry")
    print("====================")
    ...
    step(world, {"L1": "u1R", "L2": "mL", "R1": "d1R"})
    print_state("after tick 8 (single stressed carrier reaches u1R)", world)

    step(world, {"L1": "mR", "L2": "u1L", "R1": "mR"})
    print_state("after tick 9 (carrier leaves u1R; others diverted)", world)

    step(world, {"L1": "d1R", "L2": "u2L", "R1": "u1R"})
    print_state("after tick 10 (probe downstream after solo visit)", world)


def main():
    scenario_one_of_three_remote_reentry()
