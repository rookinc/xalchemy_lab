...
def scenario_two_of_three_remote_reentry():
    print("\n====================")
    print("SCENARIO: two_of_three_remote_reentry")
    print("====================")
    ...
    print_state("after tick 8 (two-of-three hit u1R once)", world)
...
def main():
    scenario_two_of_three_remote_reentry()
