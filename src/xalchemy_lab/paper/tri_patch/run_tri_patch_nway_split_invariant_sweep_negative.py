...
def make_world(node: str = "d1R") -> World:
    return World(
        turtles={
...
def run_event(world: World, node: str = "d1R") -> tuple[tuple[int, int, int], tuple[int, int, int, int, int], str]:
    world.tick += 1
...
def main() -> None:
    print("\n====================")
    print("N-WAY SPLIT INVARIANT SWEEP (NEGATIVE HUB)")
    print("====================")
    print("Domain: coherent --- triads at d1R, zero mismatch.")
