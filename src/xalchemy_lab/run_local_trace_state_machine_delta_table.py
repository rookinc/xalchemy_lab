...
def main() -> None:
    ...
    Path("specs/local_trace_state_machine_delta_table_v1.json").write_text(json.dumps(out, indent=2) + "\n")
    print("Wrote specs/local_trace_state_machine_delta_table_v1.json")
