...
def scenario_delayed_third_arrival():
    print("\n====================")
    print("SCENARIO: delayed_third_arrival")
    print("====================")
    world = make_world()
    preload_u1r(world)
    ...
    print_state("after tick 9 (hold pair at u1R awaiting delayed third)", world)

    step(world, {"L1": "u1R", "L2": "u1R", "R1": "u1R"})
    print_state("after tick 10 (delayed third arrives)", world)
...
def main():
    scenario_delayed_third_arrival()
